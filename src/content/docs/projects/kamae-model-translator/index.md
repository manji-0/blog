...
よく見る対応は [type-mapping.md](https://github.com/manji-0/kamae-model-translator/blob/main/skills/kamae-model-port/references/type-mapping.md) にまとまっています。判別union、branded ID、Result / Either、遷移成果型などです。言語内のidiomaticな表記と、wire上の表記は別物だと思ってください。
