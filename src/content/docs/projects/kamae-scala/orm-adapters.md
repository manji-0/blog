...
関連： [境界防御](/projects/kamae-scala/boundary-defense/)、[永続化、集約、イベント](/projects/kamae-scala/persistence-events/)、[段階的導入](/projects/kamae-scala/adoption/)。
...
portはORM行ではなくドメインstateを返す。[永続化、集約、イベント](/projects/kamae-scala/persistence-events/) を参照。
...
[段階的導入](/projects/kamae-scala/adoption/) を読む。
