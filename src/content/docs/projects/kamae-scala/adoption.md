...
各段の詳細は [境界防御](/projects/kamae-scala/boundary-defense/)、[アプリケーション配線](/projects/kamae-scala/application-wiring/)、[ORM アダプタ](/projects/kamae-scala/orm-adapters/) を参照する。
...
- スコープ判断に [段階的導入](/projects/kamae-scala/adoption/) を読み込む
- 実装する段のトピックガイドを読み込む
