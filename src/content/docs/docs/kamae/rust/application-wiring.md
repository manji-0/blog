...
> **関連:** [`error-handling.md`](/docs/kamae/rust/error-handling/)、[`persistence-events.md`](/docs/kamae/rust/persistence-events/)、[`persistence-events.md`](/docs/kamae/rust/persistence-events/)。
