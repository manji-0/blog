...
> **関連:** [`pii-protection.md`](/docs/kamae/rust/pii-protection/)、[`error-handling.md`](/docs/kamae/rust/error-handling/)、[`state-transitions.md`](/docs/kamae/rust/state-transitions/)。
...
log は長寿命で広くアクセス可能: 公開境界として扱う。[`pii-protection.md`](/docs/kamae/rust/pii-protection/) のルールに従う。
...
error enum 設計は [`error-handling.md`](/docs/kamae/rust/error-handling/) と照合。ユースケースが richer domain context で同一失敗を log 済みなら repository adapter で重複 log しない。
...
マスキングルールは [`pii-protection.md`](/docs/kamae/rust/pii-protection/) も参照。
...
[`pii-protection.md`](/docs/kamae/rust/pii-protection/) も照合する。生の機密値を載せるログフィールド、スパン属性、メトリクスラベル、エラー表示文字列を指摘する。
