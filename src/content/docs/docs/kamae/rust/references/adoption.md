...
[`boundary-defense.md`](/docs/kamae/rust/references/boundary-defense/) を参照。
...
[`domain-modeling.md`](/docs/kamae/rust/references/domain-modeling/) を参照。
...
[`error-handling.md`](/docs/kamae/rust/references/error-handling/) を参照。
...
[`state-transitions.md`](/docs/kamae/rust/references/state-transitions/) を参照。
...
[`persistence-events.md`](/docs/kamae/rust/references/persistence-events/) と [`application-wiring.md`](/docs/kamae/rust/references/application-wiring/) を参照。
...
[`aggregate-transactions.md`](/docs/kamae/rust/references/aggregate-transactions/) を参照。
...
- スコープ判断に [`adoption.md`](/docs/kamae/rust/references/adoption/) を読み込む
- 実装する段のトピックガイドを読み込む
