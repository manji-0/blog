...
> **関連:** [`quality-gates.md`](/docs/kamae/rust/quality-gates/)（正規チェックコマンド）、[`development-setup.md`](/docs/kamae/rust/dev-environment/)、[`ci-setup.md`](/docs/kamae/rust/ci-setup/)。
...
[`quality-gates.md`](/docs/kamae/rust/quality-gates/) のベースラインコマンドを実行する。このリポジトリでは追加で次も実行する:
...
スキルに従うアプリケーション crate（このリポジトリではない）については [`dev-environment.md`](/docs/kamae/rust/dev-environment/) を読む。
