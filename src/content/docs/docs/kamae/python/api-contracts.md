...
> **関連:** [`domain-modeling.md`](/docs/kamae/python/domain-modeling/)、[`state-transitions.md`](/docs/kamae/python/state-transitions/)、[`unsafe-boundaries.md`](/docs/kamae/python/unsafe-boundaries/)、[`persistence-events.md`](/docs/kamae/python/persistence-events/)。
...
- イベントと DTO のドキュメントでは方針本文をコピーせず、[`persistence-events.md`](/docs/kamae/python/persistence-events/) と [`boundary-defense.md`](/docs/kamae/python/boundary-defense/) へリンクする。
