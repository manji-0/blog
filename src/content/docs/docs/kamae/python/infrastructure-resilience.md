...
> **関連:** [`error-handling.md`](/docs/kamae/python/error-handling/)、[`persistence-events.md`](/docs/kamae/python/persistence-events/)、[`application-wiring.md`](/docs/kamae/python/application-wiring/)。
...
| リトライ時の重複コマンド | Application + persistence | 冪等性キー（[`persistence-events.md`](/docs/kamae/python/persistence-events/) を参照） |
...
インフラ失敗が例外のままか `Err` になるかは [`error-handling.md`](/docs/kamae/python/error-handling/) を読む。
