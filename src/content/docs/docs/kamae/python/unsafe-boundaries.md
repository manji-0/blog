...
> **関連:** [`boundary-defense.md`](/docs/kamae/python/boundary-defense/)、[`pydantic-performance.md`](/docs/kamae/python/pydantic-performance/)、[`orm-adapters.md`](/docs/kamae/python/orm-adapters/)。
...
ORM エンティティ、行 DTO、ドメイン状態間の完全なマッパーレイヤリングは [`orm-adapters.md`](/docs/kamae/python/orm-adapters/) を読む。
