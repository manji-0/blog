...
> **関連:** [`state-transitions.md`](/docs/kamae/python/state-transitions/)、[`pii-protection.md`](/docs/kamae/python/pii-protection/)、[`logging-metrics.md`](/docs/kamae/python/logging-metrics/)。
...
識別子方針については、[`pii-protection.md`](/docs/kamae/python/pii-protection/) のティアルールをアサートする:
...
識別子階層のアサーションは [`pii-protection.md`](/docs/kamae/python/pii-protection/) と突き合わせる。
