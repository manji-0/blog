...
> **関連:** [`application-wiring.md`](/docs/kamae/python/application-wiring/)、[`state-transitions.md`](/docs/kamae/python/state-transitions/)、[`infrastructure-resilience.md`](/docs/kamae/python/infrastructure-resilience/)。
...
完全なユースケースは [`state-transitions.md`](/docs/kamae/python/state-transitions/#keep-use-cases-thin) を参照。
...
ポート配線は [`application-wiring.md`](/docs/kamae/python/application-wiring/)、遅いワーカー周りのタイムアウトとリトライは [`infrastructure-resilience.md`](/docs/kamae/python/infrastructure-resilience/) を読む。
...
await/ロック相互作用は [`error-handling.md`](/docs/kamae/python/error-handling/) と [`persistence-events.md`](/docs/kamae/python/persistence-events/) と突き合わせる。
