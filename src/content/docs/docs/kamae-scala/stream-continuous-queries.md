...
write側のトランザクション、versioning、outboxの原子性は [永続化、集約、イベント](/docs/kamae-scala/persistence-events/) を参照する。
...
classpathにFS2があるときは [ライブラリガイド（FS2）](/docs/kamae-scala/library-guides/fs2/) を参照する。
