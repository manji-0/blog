...
観測の実装パターンは [ロギングとメトリクス](/docs/kamae-py/logging-metrics/)、イベントペイロードの最小化は [永続化、集約、イベント](/docs/kamae-py/persistence-events/)、テストでの検証は [テストデータ](/docs/kamae-py/test-data/) を参照する。
