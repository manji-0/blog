...
> **関連:** [`../boundary-defense.md`](/docs/kamae-rs/boundary-defense/)、[`../pii-protection.md`](/docs/kamae-rs/pii-protection/)。
...
| `serde` + `garde` | `TryFrom` 前に DTO を `garde` で検証 | [`crate-guides/garde.md`](/docs/kamae-rs/crate-guides/garde/) |
