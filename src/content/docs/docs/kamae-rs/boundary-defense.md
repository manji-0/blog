...
> **関連:** [`domain-modeling.md`](/docs/kamae-rs/domain-modeling/)、[`error-handling.md`](/docs/kamae-rs/error-handling/)、[`crate-guides/serde.md`](/docs/kamae-rs/crate-guides/serde/)。
...
不変条件を持つ単一フィールドのリーフ型では、通常コードと同じコンストラクタにデシリアライズを委譲する。[`crate-guides/serde.md`](/docs/kamae-rs/crate-guides/serde/) も参照。
...
| `garde` + `serde` + axum | `TryFrom` の前または内部で DTO を `garde` 検証; [`crate-guides/garde.md`](/docs/kamae-rs/crate-guides/garde/) 参照 |
