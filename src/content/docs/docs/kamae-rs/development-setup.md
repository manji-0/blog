...
アプリケーション開発の手順は [開発環境](/docs/kamae-rs/dev-environment/)、チェックコマンドは [品質ゲート](/docs/kamae-rs/quality-gates/)、Actions配線は [CI セットアップ](/docs/kamae-rs/ci-setup/) を参照する。
...
スキルに従うアプリケーションcrate（このリポジトリではない）については [開発環境](/docs/kamae-rs/dev-environment/) を読む。
