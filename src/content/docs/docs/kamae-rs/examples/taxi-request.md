...
> **関連:** [`domain-modeling.md`](/docs/kamae-rs/domain-modeling/)、[`state-transitions.md`](/docs/kamae-rs/state-transitions/)、[`error-handling.md`](/docs/kamae-rs/error-handling/)。
